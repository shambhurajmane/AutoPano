...
def SetupAll(BasePath, CheckPointPath):
    ...
    LabelsPathTrain = './Code/TxtFiles/LabelsTrain.txt'
    ...
    # Image Input Shape
    ImageSize = [132, 132, 3]
    NumTrainSamples = 50000 #len(DirNamesTrain)
...
def ReadLabels(LabelsPathTrain):
    if not (os.path.isfile(LabelsPathTrain)):
        ...
        with open(LabelsPathTrain, 'r') as file:
            lines = file.readlines()
        list_of_lists = [eval(line) for line in lines]
        TrainLabels = list_of_lists
...
def SetupDirNames(BasePath):
    ...
    """
    DirNamesTrain = ReadDirNames("./Code/TxtFiles/DirNamesTrain.txt")
